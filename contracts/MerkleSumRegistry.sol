...
contract MerkleSumRegistry is SolvencyRegistry {
    ...
    constructor(address[] memory reserveAddresses) SolvencyRegistry(reserveAddresses) {
    ...
    // Disable the inherited unverified root/total submission route.
