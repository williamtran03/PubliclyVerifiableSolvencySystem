...
import { customerProofFromJson } from "../prover/kzg/json.ts";
import { checkInclusion, readOnlyClient } from "./inclusion.ts";

const [
  registry,
  proofPath = "./fixtures/kzg-proof-customer-123.json",
...
const proof = customerProofFromJson(readFileSync(proofPath, "utf8"));
